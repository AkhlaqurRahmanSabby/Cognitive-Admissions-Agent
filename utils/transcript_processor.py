...
class TranscriptProcessor:
    def __init__(self):
        # Thresholds
        self.min_overall_cgpa = 3.0
        self.course_warning_threshold = 3.3

    def extract_transcript_data(self, pdf_file):
        """
    ...
    def generate_transcript_report(self, transcript_data, user_data):
        """
        ...
        - Confirm if they meet the threshold of {self.min_overall_cgpa}.
        - State Thesis status and any courses below {self.course_warning_threshold}.
        """
